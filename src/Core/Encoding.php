...
//       "\xC3\x9F"     => "\xDF", // ß
    ...
    {
        #Sixt_PartnerWs_App_Main::writeLog('toUTF8: '.$text);
...
//        Sixt_PartnerWs_App_Main::writeLog('toWin1252: '.$text);
//        exit;
    ...
    {
        $enc = preg_replace('/[^a-zA-Z0-9\s]/', '', strtoupper($encodingLabel));
        ...
        if (empty($equivalences[$enc])) {
            return 'UTF-8';
        }

        return $equivalences[$enc];
    }
    ...
    public static function encode($encodingLabel, $text)
    {
        ...
        #Sixt_PartnerWs_App_Main::writeLog('encode: '.$encodingLabel);
